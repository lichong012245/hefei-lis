...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'family_member', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Member.address'
        db.add_column(u'family_member', 'address',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'family_member', 'phone')

        # Deleting field 'Member.address'
        db.delete_column(u'family_member', 'address')
