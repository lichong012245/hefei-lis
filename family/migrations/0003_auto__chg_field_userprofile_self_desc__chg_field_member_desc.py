...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.self_desc'
        db.alter_column(u'family_userprofile', 'self_desc', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Member.desc'
        db.alter_column(u'family_member', 'desc', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.self_desc'
        db.alter_column(u'family_userprofile', 'self_desc', self.gf('django.db.models.fields.CharField')(max_length=5000))

        # Changing field 'Member.desc'
        db.alter_column(u'family_member', 'desc', self.gf('django.db.models.fields.CharField')(max_length=5000))
    ...
    models = {
        ...
        u'family.userprofile': {
            ...
            'self_desc': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
